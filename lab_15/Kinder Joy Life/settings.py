...
NAZWY_FIGUREK = [
    ...
    "Charged Creeper", "Enderman", "Zombie", "Skeleton",
    "Ender Dragon", "Pig", "Sheep", "Frog", "Axolotl",
    "Shulker", "Breeze"
]

SZANSE_LOSOWANIA = [6, 6, 6, 6, 6, 6, 6, 6, 6, 4, 6, 6, 6, 6, 6, 4]

T = {
    'pl': {
        'title': "Kinder Joy Simulator",
        'subtitle': "Minecraft Edition",
        'start': "START GRY",
        'collection': "Twoja kolekcja:",
        'eggs_left': "Zapas jajek:",
        'click_open': "KLIKNIJ JAJKO ABY OTWORZYC",
        'go_shop': "JEDZ DO BIEDRONKI",
        'shop_name': "BIEDRONKA",
        'what_to_do': "Otworzyles jajko! Co robisz z czekolada?",
        'eat': "ZJEDZ",
    ...
    'en': {
        ...
        'eggs_left': "Eggs left:",
        'click_open': "CLICK EGG TO OPEN",
        'go_shop': "GO TO LIDL",
        'shop_name': "LIDL",
        'what_to_do': "You opened the egg! What about the chocolate?",
        'eat': "EAT",
